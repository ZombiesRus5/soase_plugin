 ...
 */
public class SinsHoverInformationalControl extends AbstractInformationControl 
     ...
     */
    public SinsHoverInformationalControl(Shell parent) {
    ...
    public IInformationControlCreator getInformationPresenterControlCreator() {
        return new IInformationControlCreator() {
            ...
            public IInformationControl createInformationControl(Shell parent) {
                return new SinsHoverInformationalControl(parent);
            }
        };
    }
